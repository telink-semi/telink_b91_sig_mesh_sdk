...
#include "stack/ble/attr/attr_stack.h"
...
volatile  u8 dev_auth[16];
#if(!__PROJECT_MESH_PRO__)
volatile  u8 dev_edch[32];
volatile u8 dev_random[16]={0x55,0xa2,0xa2,0xbc,0xa0,0x4c,0xd3,0x2f, 0xf6,0xf3,0x46,0xbd,0x0a,0x0c,0x1a,0x3a};
volatile  u8 dev_comfirm[16];
u8 dev_input[0x91];
volatile u8 pro_random[16];
